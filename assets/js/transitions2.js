    ...
    finish: function () {
        ...
        Promise.all([pro1, pro2, pro3, pro4]).then(values => {
            ...
            $(this.oldContainer)
                ...
                .animate(
                    {
                        left: "+=" + 2 * aboutWidth + "px",
                        top: "+=" + 2 * aboutHeight + "px"
                    },
                    400
                );
            $(this.oldContainer)
                ...
                .animate(
                    {
                        left: "-=" + 2 * contactWidth + "px",
                        top: "-=" + 2 * contactHeight + "px"
                    },
                    400
                );
            $(this.oldContainer)
                ...
                .animate(
                    {
                        left: "-=" + 2 * projectsWidth + "px",
                        top: "+=" + 2 * projectsHeight + "px"
                    },
                    400
                );
            $(this.oldContainer)
                ...
                .animate(
                    {
                        left: "+=" + 2 * algorithmsWidth + "px",
                        top: "-=" + 2 * algorithmsHeight + "px"
                    },
                    400,
                    function () {
